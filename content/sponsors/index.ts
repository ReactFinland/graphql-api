...
export { default as apidays } from "./apidays";
...
export { default as frankenjs } from "./frankenjs";
...
export { default as haagahelia } from "./haagahelia";
...
export { default as monolisa } from "./monolisa";
