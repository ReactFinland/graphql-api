...
const person: Contact = {
  ...
  about: `Christoffer Niska is a software engineer and toolbuilder with over 15 years of experience. He built Acolyte, an open-source AI coding agent, to own every layer of his workflow: the model, the tools, the memory, and the execution. He specialises in developer tooling and TypeScript, and writes about building with AI at [crisu.me](https://crisu.me).`,
  image: {
