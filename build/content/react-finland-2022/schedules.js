            ...
            sessions: [
                {
                    type: Session_1.SessionType.ORGANIZATIONAL,
                    title: "Registration and breakfast",
                    description: "Register and enjoy breakfast (for full day and morning workshops only).",
                },
            ],
        },
        {
            ...
            sessions: [
                {
                    type: Session_1.SessionType.LUNCH,
                    title: "Lunch",
                    description: "We have Finnish food in store for people attending full day workshops or two workshops (morning and afternoon sessions).",
                },
            ],
        },
        {
            ...
            sessions: [
                {
                    ...
                    type: Session_1.SessionType.PANEL,
            ...
            sessions: [
                {
                    type: Session_1.SessionType.WORKSHOP,
                    people: [people.m4Dz, people.varyaStepanova],
                    title: "Design systems governance models and transitions between them",
            ...
            sessions: [
                {
                    ...
                    urls: {
                        video: "https://www.youtube.com/watch?v=kj6iQ1rR_lA&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=2&t=361s",
                    },
                },
            ],
        },
            ...
            sessions: [
                {
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=0ihYcjMhM-4&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=3",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
                    level: Session_1.Level.INTERMEDIATE,
                    title: "Bringing the New React Native Architecture to the OSS community",
...
In the talk, we will present how the New React Native Architecture looks in the OSS space. We will discuss the impact this will have on developing React Native projects. Lastly, we will cover what we learned from the React Native New Architecture migration at Meta, and how you can tackle your migration in your organization.`,
                    ...
                    urls: {
                        ...
                        slides: "https://drive.google.com/file/d/1ZXy1MhzOloDV5nh22jLQK-mpLEaAVa4Z/view?usp=sharing",
                        video: "https://www.youtube.com/watch?v=zyTYWAeORKg&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=4",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
...
In this talk, Ryan, author of SolidJS, will look at what comes after the component model. Driven by the need for more granularity, and empowered by compilation, reactivity is becoming the universal language of user interfaces.`,
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=O6xtMrDEhcE&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=5",
                    },
                },
            ],
        },
            ...
            sessions: [
                {
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=tCyOdW4D6b8&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=6",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=NIhXfXJmJF8&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=7",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
                    ...
                    urls: {
                        ...
                        slides: "https://drive.google.com/file/d/1TSKtOOC-kCwLG8vo75bSk9Ym6aIiZw5j/view?usp=sharing",
                        video: "https://www.youtube.com/watch?v=sizarzUoQTA&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=8",
                    },
                },
            ],
        },
...
All these weird things are part of our favourite library (not a framework™) and yet we still use and love it. Why actually? Let's talk about. Disclaimer: This is not a very serious talk, mostly …`,
                    ...
                    urls: {
                        ...
                        slides: "https://drive.google.com/file/d/1iX-6yxhzJhCwYuaShLZEYCJwKAQdvCs2/view?usp=sharing",
                        video: "https://www.youtube.com/watch?v=25QQcPSzH8Y&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=9",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=JevYDCy5HzA&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=10",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=bubX1q9hrAo&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=11",
                    },
                },
            ],
        },
            ...
            sessions: [
                {
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=DRj1ScxWri4&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=12",
                    },
                },
            ],
        },
            ...
            sessions: [
                {
                    ...
                    urls: {
                        video: "https://www.youtube.com/watch?v=F_4QaYxEq_g&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=13",
                    },
                },
            ],
        },
            ...
            sessions: [
                {
                    type: Session_1.SessionType.TALK,
                    level: Session_1.Level.INTERMEDIATE,
                    title: "The (sometimes harsh) reality of landing a relevant role in Finland",
...
* Identifying the right companies to apply if applying remotely`,
                    ...
                    urls: {
                        ...
                        slides: "https://drive.google.com/file/d/1x3X9i0Er4vD2Z0bohSrkt2htRIcNyHt7/view?usp=sharing",
                        video: "https://www.youtube.com/watch?v=YrmEF29kF1Q&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=14",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
                    level: Session_1.Level.INTERMEDIATE,
                    title: "What do companies look for in a developer – the recruiter point of view",
...
* How the skills and competences are assessed in interviews`,
                    ...
                    urls: {
                        ...
                        slides: "https://drive.google.com/file/d/1cfBHesZ22dpXjuJY5DQTkX32Dxk3zs6W/view?usp=sharing",
                        video: "https://www.youtube.com/watch?v=aulujb2gdtI&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=15&t=3s",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
...
* How to cope with relocation in the first two weeks?`,
                    ...
                    urls: {
                        ...
                        slides: "https://drive.google.com/file/d/1NiDu8YYXFxt2YBiw9TLLDDIRMXm4Lytw/view?usp=sharing",
                        video: "https://www.youtube.com/watch?v=fkFaTzvj0mE&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=16",
                    },
                },
            ],
        },
...
We'll go through what the web can actually accomplish on it's own at the moment, and some useful tools to assist in developing more vendorless, portable experiences.`,
                    ...
                    urls: {
                        ...
                        slides: "https://drive.google.com/file/d/1qQMy-v0682ijDErUc4kvHS0WILPvDtmn/view?usp=sharing",
                        video: "https://www.youtube.com/watch?v=oy1hiAO5Cl0&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=18",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
...
API-first backend only requires HTTP streams, and Web Components embed the required network primitives. Should we distribute a JS SDK or a library of Web Components for our service? Here's the match between the two giants! SDKs vs Web Components: Place Your Bets.`,
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=NjZaNvxJAWE&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=19",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
            ...
            We are going to tackle it by doing more work at build time which means we start with almost zero JavaScript and only load more as the users interacts with the page.`,
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=V2yjXFPYjVA&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=20",
                    },
                },
            ],
        },
            ...
            sessions: [
                {
                    ...
                    urls: {
                        ...
                        slides: "https://drive.google.com/file/d/1Ry5NYtWn3-MgKvsK0IQ70aOVkr2AhqAI/view?usp=sharing",
                        video: "https://www.youtube.com/watch?v=8ACxWOjrTfs&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=22",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
                    ...
                    urls: {
                        ...
                        slides: "https://drive.google.com/file/d/1pqA_lDeArDipKT6Nr8KDAfUUXWn6_o-E/view?usp=sharing",
                        video: "https://www.youtube.com/watch?v=st8RoQIiqaE&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=23",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
            ...
            sessions: [
                {
                    ...
                    description: "Web accessibility is much more than regulations and restrictions. It is based on real people with real problems and needs. By understanding all the users everything makes a lot more sense. In her talk Marianna addresses the ‘why’ of accessibility – and a little bit of the ‘how’, too.",
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=2GZrkN2eUiA&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=25",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
                    ...
                    urls: {
                        ...
                        video: "https://www.youtube.com/watch?v=zjuhVEav4qc&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=26",
                    },
                },
                {
                    type: Session_1.SessionType.TALK,
            ...
            sessions: [
                {
                    ...
                    urls: {
                        video: "https://www.youtube.com/watch?v=6Gsi_yOU1xg&list=PL-a9lBflNu2ph1J-a19LNLo3GKikBDsWZ&index=28",
                    },
                },
            ],
        },
            ...
            sessions: [
                {
                    type: Session_1.SessionType.PARTY,
                    title: "Afterparty",
                    description: "[Register separately using this link](https://forms.gle/2NeK5PjaoFQ2GENVA). The registration helps us to have the right amount of everything.",
                },
            ],
