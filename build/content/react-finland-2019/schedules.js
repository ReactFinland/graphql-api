            ...
            sessions: [
                {
                    ...
                    description: "Pro tip: You can register at any time during the conference. There's light breakfast (pastry and coffee) available.",
                },
            ],
        },
        {
            ...
            sessions: [
                {
                    type: Session_1.SessionType.COFFEE_BREAK,
                    title: "Break",
                    description: "Drink coffee if you still can. Enjoy the sofa at the sponsors' lounge.",
                },
            ],
        },
        {
            ...
            sessions: [
                {
                    type: Session_1.SessionType.ORGANIZATIONAL,
                    title: "Registration and breakfast",
                    description: "If you slept late, you can still register after this. There's light breakfast (pastry and coffee) available.",
                },
            ],
        },
        {
            ...
            sessions: [
                {
                    type: Session_1.SessionType.COFFEE_BREAK,
                    title: "Break",
                    description: "Drink coffee and play games at the sponsors' lounge. Finnish coffee is darker than you think.",
                },
            ],
        },
        {
            ...
            sessions: [
                {
                    type: Session_1.SessionType.COFFEE_BREAK,
                    title: "Break",
                    description: "Drink coffee. Again. Play more foosball at the sponsors' lounge.",
                },
            ],
        },
        {
            ...
            sessions: [
                {
                    type: Session_1.SessionType.COFFEE_BREAK,
                    title: "Break",
                    description: "Drink coffee if you still can. Still time for a massage at the sponsors' lounge.",
                },
            ],
        },
        {
